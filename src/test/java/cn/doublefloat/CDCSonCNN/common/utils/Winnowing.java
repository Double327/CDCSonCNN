...
class Winnowing {
    @Test
    void testWinnowing(){
        cn.doublefloat.CDCSonCNN.projects.code_anlysis.algorithm.winnowing.Winnowing winnowing
                = new cn.doublefloat.CDCSonCNN.projects.code_anlysis.algorithm.winnowing.Winnowing();
